      ...
      <div class="content">
        ...
        <div class="loginPanel">
          <ul v-if="this.$store.state.isLogin==false">
            ...
            <li>
              <router-link to class="text">消息通知</router-link>
            </li>
          </ul>
          <ul v-else>
            <li>
        ...
        <div class="cart" @mouseover="showGwc()" @mouseout="hideGwc()">
          <router-link to="/cart" class="shop a1">
            <span class="shopping">购物车({{totalSelected}})</span>
          </router-link>
          <div class='goods' :class="{'goodsShow': showGwcBz}">
    ...
    <div class="frame">
      ...
      <div class="searchbar">
        <input
          ...
          v-model="keyword"
        />
        <a :class="{active:isactive}" @click="searchProduct" style="cursor:pointer;">搜索</a>
...
.header .head_container .cart .goodsShow {
  display: block;
